...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <p>${product.rating.count} people like this</p>
      <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
      <button onclick="detailButton()" class="btn btn-danger">Details</button></div>
      `;
...
const updateTotal = () => {
  ...
  const grandTotalParse = parseFloat(grandTotal)
  document.getElementById("total").innerText = grandTotalParse;
};
loadProducts();
